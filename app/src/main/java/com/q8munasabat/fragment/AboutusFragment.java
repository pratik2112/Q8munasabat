...
public class AboutusFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_manage_content, container, false);
    ...
    private void inticompnets() {
        try {
            ((DashboardActivity) getActivity()).setTitle(getString(R.string.menu_title_9));
    ...
    private void getAboutContent() {
        try {
            if (CommonFunctions.checkConnection(getActivity())) {
                ...
                data.put(Constants.slug, Constants.about_us);
